...
-- 윈도우 > 설정 > 연결 > 연결유형 AUTO COMMIT BY DEFAULT 체크 해제 확인 ( 자동으로 영구저장? )
...
VALUES('900', '홍길동', '968125-1657891', 'hong_gd_or.kr', '01011111111', 'D1',
...
SELECT * FROM EMPLOYEE2 
WHERE EMP_ID = '900'; -- (영구저장 되었기 때문에 롤백해도 홍길동 남아있음)
...
-- DEPARTMENT2 테이블에서 DEPT_ID가 'D9' 인 부서의 DEPT_TITLE
-- 을 '전략기획팀'으로 수정
UPDATE DEPARTMENT2 
