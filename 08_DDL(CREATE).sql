 ...
 *  USER_CONS_COLUMNS : 제약조건이 걸려잇는 컬럼을 확인하는 딕셔너리 뷰
 * 제약조건 -> 이름 ( 명시 / 명시 X 가능 )
 * */
...
CREATE TABLE "MEMBER" (
	...
	MEMBER_SSN CHAR(14), -- '991231-1234567'
	ENROLL_DATE DATE DEFAULT SYSDATE -- 시스템상 현재시간
);
...
('MEM01', '123ABC', '홍길동', '971648-1784561', DEFAULT);
...
INSERT INTO MEMBER2 VALUES('MEM01' , 'PASS01', '고길동', 01014781515); -- 1,014,781,515 로 출력됨
...
-- 전화번호, 주민등록번호 처럼 숫자로만 되어있는 데이터라도 0으로 시작할 가능성이있으면
-- CHAR, VARCHAR2 같은 문자형을 사용해서 테이블을 생성해야함
----------------------------------
-- 제약 조건 (CONSTRAINTS)
...
-- SQL Error [1400] [23000]: ORA-01400: NULL을 ("KH_KYU"."USER_USED_NN"."USER_NO") 안에 삽입할 수 없습니다 
-- -> NOT NULL 조건에 걸림
...
DROP TABLE USER_USED_UK; -- 테이블 제거
...
INSERT INTO USER_USED_UK
VALUES (1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [1400] [23000]: ORA-01400: NULL을 ("KH_KYU"."USER_USED_UK"."USER_NO") 안에 삽입할 수 없습니다 (NULL을 첫열에 넣을경우)
-- SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(KH_KYU.USER_ID_U)에 위배됩니다
...
INSERT INTO USER_USED_UK2
VALUES (3, 'USER01', 'PASS01', '고길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');

INSERT INTO USER_USED_UK
VALUES (4, 'USER01', 'PASS01','홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
...
-- 한 테이블당 한 개만 설정할 수 있음 그렇군요
-- 컬럼레벨과 테이블레벨 둘 다 설정할 수 읶다
-- 한 개 컬럼에 설정할 수 있고, 여러개의 컬럼을 묶어서 설정할 수 있음(== PRIMARY 복합키)


CREATE TABLE "USER_USED_PK" (
	USER_NO NUMBER CONSTRAINT USER_NO_PK PRIMARY KEY, -- 컬럼 레벨 ( 제약조건명 )
	USER_ID VARCHAR2(20),
	USER_PWD VARCHAR2(20),
	USER_NAME VARCHAR2(30),
	GENDER VARCHAR2(10),
...
INSERT INTO USER_USED_PK
VALUES (1, 'USER02', 'PASS02','곽재우', '남자', '010-1234-5678', 'qong123@kh.or.kr');
-- 기본키 중복 오류! 
-- SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(KH_KYU.USER_NO_PK)에 위배됩니다

INSERT INTO USER_USED_PK
VALUES (NULL, 'USER02', 'PASS02','박재우', '남자', '010-1234-5678', 'qong123@kh.or.kr');
-- 기본키 NULL이므로 오류
-- SQL Error [1400] [23000]: ORA-01400: NULL을 ("KH_KYU"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다

INSERT INTO USER_USED_PK
VALUES (2, 'USER02', 'PASS02','박재우', '남자', '010-1234-5678', 'qong123@kh.or.kr');
...
INSERT INTO USER_USED_PK2
VALUES (1, 'USER02', 'PASS01','홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');

INSERT INTO USER_USED_PK2
VALUES (2, 'USER01', 'PASS01','홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');

INSERT INTO USER_USED_PK2
VALUES (1, 'USER01', 'PASS01','홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
--SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(KH_KYU.PK_USERNO_USERID)에 위배됩니다
-- USER_NO, USER_ID 둘 다 중복되었을 때만 제약조건 위배 에러 발생!

INSERT INTO USER_USED_PK2
VALUES (NULL, 'USER03', 'PASS01','홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
--SQL Error [1400] [23000]: ORA-01400: NULL을 ("KH_KYU"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다

INSERT INTO USER_USED_PK2
VALUES (3, NULL, 'PASS01','홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [1400] [23000]: ORA-01400: NULL을 ("KH_KYU"."USER_USED_PK2"."USER_ID") 안에 삽입할 수 없습니다
...
-- 부모테이블 / 자식테이블 / 레퍼런스 테이블 ( 대상이 되는 테이블 )
...
CREATE TABLE USER_USED_FK(
	USER_NO NUMBER PRIMARY KEY, -- 사용자 번호(고유한 번호 : 중복 X / NOT NULL)
	...
	PHONE VARCHAR2(30),
	EMAIL VARCHAR2(50),
	GRADE_CODE NUMBER CONSTRAINT GRADE_CODE_FK REFERENCES USER_GRADE -- 생략가능(GRADE_CODE) -- 컬럼레벨 (컬럼명 미작성시 USER_GRADE 테이블의 PK를 자동참조~)

	-- 테이블레벨
	-- , CONSTRAINT GRADE_CODE_FK FOREIGN KEY(GRADE_CODE) REFERENCES USER_GRADE -> FOREIGN KEY 라는 단어는 테이블 레벨에서만 사용!
...
-- USER_GRADE ( 부모테이블 / 참조테이블 ) 에 10이라는 GRADE_CODE가 존재하므로 가능

INSERT INTO USER_USED_FK
VALUES (2, 'USER02', 'PASS02','이순신', '남자', '010-1234-5678', 'hng123@kh.or.kr', 10);
-- USER_GRADE ( 부모테이블 / 참조테이블 ) 에 10이라는 GRADE_CODE가 존재하므로 가능

INSERT INTO USER_USED_FK
VALUES (3, 'USER03', 'PASS03','유관순', '여자', '010-1234-5678', 'ahn123@kh.or.kr', NULL);
-- USER_GRADE ( 부모테이블 / 참조테이블 ) 에 10이라는 GRADE_CODE가 존재하므로 가능

INSERT INTO USER_USED_FK
VALUES (4, 'USER04', 'PASS04','신립', '남자', '010-1234-5678', 'hng123@kh.or.kr', 30);

INSERT INTO USER_USED_FK
VALUES (5, 'USER05', 'PASS05','윤봉길', '남자', '010-1234-5678', 'yng123@kh.or.kr', 50);
-- SQL Error [2291] [23000]: ORA-02291: 무결성 제약조건(KH_KYU.GRADE_CODE_FK)이 위배되었습니다- 부모 키가 없습니다
...
-- FOREIGN KEY로 지정된 칼럼에서 사용되고 있는 값일 경우
-- 제공되는 컬럼의 값은 삭제하지 못함.

DELETE FROM USER_GRADE WHERE GRADE_CODE = 30;
-- SQL Error [2292] [23000]:
-- ORA-02292: 무결성 제약조건(KH_KYU.GRADE_CODE_FK)이 위배되었습니다- 자식 레코드가 발견되었습니다
...
--> ON DELETE SET NULL 옵션이 설정되어있어서 오류없이 삭제됨
...
EMAIL VARCHAR2(50),
GRADE_CODE NUMBER ,
CONSTRAINT GRADE_CODE_FK3 FOREIGN KEY(GRADE_CODE) REFERENCES 
...
SELECT * FROM USER_USED_FK3; -- 부모의 10 참조하고 있떤 자식 행 삭제됨
...
VALUES (1, 'USER01', 'PASS01','홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [2290] [23000]: ORA-02290: 체크 제약조건(KH_KYU.GENDER_CHECK)이 위배되었습니다.

INSERT INTO USER_USED_CHECK
VALUES (1, 'USER01', 'PASS01','홍길동', '남', '010-1234-5678', 'hong123@kh.or.kr');

INSERT INTO USER_USED_CHECK
VALUES (2, 'USER02', 'PASS01','장보고', '여', '010-1234-5678', 'hong123@kh.or.kr');
